                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                 ...
                                 <!-- $url = route('login') . '?map_url=' . urlencode($https://www.google.com/maps/d/u/0/viewer?msa=0&mid=1kW6vyoGKE4Vgr8i_a6qNW9w8fKA&ll=38.44403372841546%2C-122.44234000000002&z=10); -->
